...
import '../../services/models/entitiy_model.dart';
import '../results/data_result.dart';
import '../results/error_data_result.dart';
import '../results/success_data_result.dart';

mixin JsonEntityConverterMixin {
  final _parseError = 'Model ayrıştırılırken bir hata meydana geldi.';
  ...
  DataResult<TReturn> convertEntity<TReturn, TModel>(
